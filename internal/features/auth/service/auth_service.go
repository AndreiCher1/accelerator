...
// возвращает ошибки с разных уровней и информацию о токенах, а также роль пользователя
...
// возвращает новую пару токенов c информацией о них, а также роль пользователя
func (serv *AuthService) RefreshUserService(ctx context.Context, refreshToken string) (*domains.ReturnCreateTokensInfo, string, error) {
	...
	return tokensInfo, userRole, nil
}
