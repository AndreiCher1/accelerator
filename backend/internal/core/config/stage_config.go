	...
	return &[]StageConfig{
		{
			...
			EndPoint:         getEnvString("DENOISE_WORKER_URL", "localhost:8001/api/ai/denoise"),
		...
		},
		{
			...
			EndPoint:         getEnvString("TRANSCRIBE_WORKER_URL", "localhost:8002/api/ai/transcribe"),
		...
		},
		{
			...
			EndPoint:         getEnvString("DIARIZE_WORKER_URL", "localhost:8003/api/ai/diarize"),
		...
		},
		{
			...
			EndPoint:         getEnvString("SUMMARY_WORKER_URL", "localhost:8004/api/ai/summarize"),
